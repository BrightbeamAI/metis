"""TacitFlow, a reference toolkit for governed tacit fragment capture.

TacitFlow captures situated human practice as partial, validated, context-bound fragments
...
__all__ = ["TacitFlowEngine", "__version__"]
