"""TacitFlowEngine, the public façade that wires the toolkit together over one CHAP adapter.

TacitFlow domain model first, tacit memory second, local AI assistance third, CHAP
...
class TacitFlowEngine:
    def __init__(
        self,
        workspace_id: str = "wsp_tacitflow_demo",
        name: str = "TacitFlow Capture Cell",
        *,
        ...
        self.mission_group_uri = "group:mission-group@tacitflow.local"
