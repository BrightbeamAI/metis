...
def model_check() -> None:
    ...
    if up:
        ...
        typer.echo("Ollama not reachable. TacitFlow will use deterministic fixtures.")
        typer.echo("Install from https://ollama.com and run `ollama serve`, then `tacitflow model pull gemma4`.")
