"""The TacitFlow operating loop: Observe -> Infer -> Whisper -> Confirm -> Remember.

Each stage is a TacitFlow action emitted as a CHAP event/artefact through the adapter. A
...
class CaptureLoop:
    def __init__(
        ...
        *,
        ...
        operator_uri: str,
        whisperer_uri: str,
        mission_group_uri: str = "group:mission-group@tacitflow.local",
