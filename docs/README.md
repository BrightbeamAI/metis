...
- **[explainer.html](explainer.html)** is a single-page, illustrated tour of TacitFlow with
...
| [agent_memory_use.md](agent_memory_use.md) | How an AI agent should consume TacitFlow output and respect use constraints. |

## Reference

| Doc | What it covers |
|-----|----------------|
| [chap_integration.md](chap_integration.md) | How TacitFlow maps onto CHAP and which CHAP capabilities it uses. |
| [tacitflow_profile.md](tacitflow_profile.md) | The `tacitflow/1.0` profile: task kinds, artefact kinds, and rules. |
